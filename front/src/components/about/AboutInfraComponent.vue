  ...
  <div class="about-infra-component">
    <div className="max-w-[34rem] px-2 m-auto">
      ...
      <div className="text-justify">
        <div className="my-2">
          A Psiquiatria é um ramo da medicina que se dedica ao estudo, diagnóstico, tratamento e prevenção dos transtornos
        ...
        <div className="my-2">
          O principal objetivo da Psiquiatria é oferecer cuidados abrangentes para indivíduos que sofrem de uma ampla gama
          de condições psiquiátricas.
        </div>
        <div className="my-2">
          A prática psiquiátrica abrange desde condições comuns, como ansiedade e depressão, até transtornos mais
        ...
        <div className="my-2">
          A abordagem da Psiquiatria é multidisciplinar, integrando aspectos biológicos, psicológicos e sociais no
          entendimento e tratamento dos transtornos mentais.
        </div>
        <div className="my-2">
          Além de tratar os pacientes, os psiquiatras desempenham um papel vital na educação, na pesquisa e na
        ...
        <div className="my-2">
          Em resumo, a Psiquiatria é um campo essencial da medicina que se concentra no cuidado da saúde mental. Seu
